...
output_dir = 'outputs/linea_hgnetv2_n'

# Full-training defaults target one 80--96 GiB accelerator.  Low-memory smoke
# runs must override these values explicitly from the CLI.

...
def init_distributed_mode(args):
    # torchrun publishes these variables. Absence means an ordinary
    # single-process invocation; real initialization failures stay visible.
    ...
    if torch.cuda.is_available():
        # A multi-node global rank can exceed the local GPU count.

        ...
        if filename.lower().endswith('.py'):
            with tempfile.TemporaryDirectory() as temp_config_dir:
                ...
                cfg_dict = {
                    ...
                    # A single leading underscore denotes a config-local helper.
                    # Keep only the inheritance directive, which is part of the
                    # public config syntax.  This prevents imported helper
                    # functions/dataclasses from leaking into resolved configs
                    # and breaking pretty-printing/serialization.
                    if name == BASE_KEY or not name.startswith('_')
                }
